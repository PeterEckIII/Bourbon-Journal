// describe("New Review", () => {
//   it("successfully fills out a new review", () => {
//     cy.login();
...
//     cy.wait(10000);
//     cy.get("#upload-confirmation").should("be.visible");
//     cy.get("#next-button").click();
...
//     cy.url().should("match", /\/reviews/);
//     cy.get("#create-new-review-link").should("be.visible");
//   });
// });
