...
describe("smoke tests", () => {
  ...
  it("should allow you to make a review", () => {
    ...
    //   candy: faker.datatype.number({ min: 0, max: 5 }),
    //   baked: faker.datatype.number({ min: 0, max: 5 }),
    //   buttery: faker.datatype.number({ min: 0, max: 5 }),
    ...
    //   bakingSpices: faker.datatype.number({ min: 0, max: 5 }),
    //   molasses: faker.datatype.number({ min: 0, max: 5 }),
    //   nutty: faker.datatype.number({ min: 0, max: 5 }),
    //   oaky: faker.datatype.number({ min: 0, max: 5 }),
    //   redFruit: faker.datatype.number({ min: 0, max: 5 }),
    //   darkFruit: faker.datatype.number({ min: 0, max: 5 }),
    //   berryFruit: faker.datatype.number({ min: 0, max: 5 }),
    //   citrusFruit: faker.datatype.number({ min: 0, max: 5 }),
    //   stoneFruit: faker.datatype.number({ min: 0, max: 5 }),
    //   driedFruit: faker.datatype.number({ min: 0, max: 5 }),
    //   earthy: faker.datatype.number({ min: 0, max: 5 }),
    ...
    //   herbaceous: faker.datatype.number({ min: 0, max: 5 }),
